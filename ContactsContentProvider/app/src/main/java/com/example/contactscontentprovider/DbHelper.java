...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public Cursor selectAll(){
        this.getReadableDatabase().query(TABLE_NAME,null,null, null,null,null,null);
    }

    public Cursor selectContactById(long id){
        this.getReadableDatabase().query(TABLE_NAME,null,"rowid=?", new String[]{id+""},null,null,null);
    }
}
